...
! function (t) {
    ...
    e.clone = c, e.addLast = l, e.addFirst = d, e.removeLast = p, e.removeFirst = v, e.insert = h, e.removeAt = g, e.replaceAt = E, e.getIn = m, e.set = _, e.setIn = y, e.update = I, e.updateIn = b, e.merge = w, e.mergeDeep = T, e.mergeIn = O, e.omit = A, e.addDefaults = x;
    /*!
     * Timm
     *
    ...
    n(121), n(123), n(22), n(125), n(315), n(316), n(317), n(318), n(319), n(324), n(325), t.exports = n(326)
}, function (t, e, n) {
    "use strict";
    var r = n(3);
        ...
        b = function (t, e) {
            ...
            for (var O = 0, A = i.length; O < A; O++) {
                ...
                if (0 === O && (g = R[0]), T >= S) {
                    ...
                    var C = i[O + 1],
                        N = C && T !== S;
                    E = N ? C.actionItems[0] : null, N && (m = S / 100, y = (C.keyframe - S) / 100)
                }
            }
            var L = {};
            if (g && !E)
                for (var D = 0, P = a.length; D < P; D++) {
                    ...
                    for (var j = (w - m) / y, F = g.config.easing, k = h(F, j, f), X = 0, G = a.length; X < G; X++) {
                        var U = a[X],
                            V = _(s, U, g.config),
    ...
    r.define("dropdown", t.exports = function (t, e) {
        ...
        function S(e, i) {
            ...
            }(f)), f.el.on(T, E), f.el.on(_, function (t) {
                return function (e) {
            ...
            }(f)), f.toggle.on(w, E), f.toggle.on(_, function (t) {
                var e = C(t, a);
                return function (r) {
                    if (!n && !d) {
            ...
            if (e.index !== e.previous) {
                if (e.ariaLiveLabel.text("Slide ".concat(o + 1, " of ").concat(i.length, ".")), "cross" === _) {
                    var O = Math.round(I - I * r.crossOver),
                        A = Math.round(I - O);
                    return w = "opacity " + O + "ms " + y, l(g).set({
                        visibility: ""
                    }).add(w).start({
                        opacity: 0
                    }), void l(h).set({
...
Webflow.require('ix2').init({
    "events": {
        "e-3": {
            ...
            "target": {
                "id": "60ba14607a2b8cc5c855de7d|3177d3da-e085-bb10-f12f-85fc87f71e97",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-4": {
            ...
            "mediaQueries": ["main"],
            "target": {
                "id": "60b9597d22fa2471c8411f84|67e6d1e5-ef73-60e4-5630-da10bb288c01",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-6": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "60b9576285b274e07dd81b8a|b6b0a63f-77fd-91d8-cc19-f1ad68c88d14",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-7": {
            ...
            "target": {
                "id": "60b9005fe0e33682fa48232b|4f219f59-fffb-52de-d322-337c6655038f",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-8": {
            ...
            "target": {
                ...
                "originalId": "60b920ea81ba3ec07e80a368|2fb40dad-dc79-6f48-8a26-a33598c22bb4",
                "appliesTo": "CLASS"
            },
            "targets": [{
                "selector": ".slide-wrapper",
        ...
        "e-12": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "60ba5a1884b19c5953b78ff6|337e3bcb-1cdf-bf16-6a04-690951b3ff63",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
            ...
            "createdOn": 1623450056520
        }
    },
    "actionLists": {
        "a-3": {
            "id": "a-3",
            "title": "Project page 4 scroll animation",
                ...
                "continuousActionGroups": [{
                    ...
                    "actionItems": [{
                        ...
                        "config": {
                            ...
                            "target": {
                                "boundaryMode": true,
                                "id": "60ba14607a2b8cc5c855de7d|3268e91a-75e6-66ae-6c76-71ab0fb0d6e2"
                            },
                            "yValue": 0,
                            "xUnit": "PX",
                            "yUnit": "%",
            ...
            "createdOn": 1623013377671
        },
        "a-4": {
            "id": "a-4",
            "title": "Project title link hover on",
            "actionItemGroups": [{
                "actionItems": [{
                    "id": "a-4-n-3",
                    ...
                    "config": {
                        ...
                        "target": {
                            ...
                            "selector": ".img-wrapper-large",
                            "selectorGuids": ["8b41c03d-ddbf-ae92-d732-813de37dfdd0"]
                        },
                        "value": 0,
                        "unit": ""
                    }
                    ...
                    "config": {
                        ...
                        "target": {
                            "useEventTarget": "SIBLINGS",
                            "selector": ".img-wrapper-small",
                            "selectorGuids": ["a1007ce8-af46-a368-82a7-e2ae3753f514"]
                        },
                        "value": 0,
                        "unit": ""
                    }
            ...
            "createdOn": 1623014516946
        },
        "a-5": {
            "id": "a-5",
            "title": "Project title link hover out",
            "actionItemGroups": [{
                "actionItems": [{
                    "id": "a-5-n",
                    "actionTypeId": "STYLE_OPACITY",
        ...
        "a-6": {
            "id": "a-6",
            "title": "Project page 2 scroll animation",
            "continuousParameterGroups": [{
                "id": "a-6-p",
                "type": "SCROLL_PROGRESS",
                "parameterLabel": "Scroll",
                    ...
                    "actionItems": [{
                        ...
                        "config": {
                            ...
                            "target": {
                                ...
                                "selector": ".row-content-wrapper",
                                "selectorGuids": ["e0ca8df7-93a9-4536-f710-69b492da104a"]
                            },
                            "xValue": 10,
                            "xUnit": "%",
                            "yUnit": "PX",
            ...
            "createdOn": 1623015484445
        },
        "a-7": {
            "id": "a-7",
            "title": "Home scroll animation",
            "continuousParameterGroups": [{
                "id": "a-7-p",
                "type": "SCROLL_PROGRESS",
                "parameterLabel": "Scroll",
                "continuousActionGroups": [{
                    ...
                    "actionItems": [{
                        ...
                        "config": {
                            ...
                            "target": {
                                "useEventTarget": "CHILDREN",
                                "id": "60b9005fe0e33682fa48232b|4f219f59-fffb-52de-d322-337c66550393"
                            },
                            "yValue": 0,
                            "xUnit": "PX",
                            "yUnit": "em",
                        ...
                        "config": {
                            ...
                            "target": {
                                "useEventTarget": "CHILDREN",
                                "id": "60b9005fe0e33682fa48232b|4f219f59-fffb-52de-d322-337c66550397"
                            },
                            "yValue": 0,
                            "xUnit": "PX",
                            "yUnit": "em",
                        ...
                        "config": {
                            ...
                            "target": {
                                "useEventTarget": "CHILDREN",
                                "id": "60b9005fe0e33682fa48232b|4f219f59-fffb-52de-d322-337c66550399"
                            },
                            "yValue": 0,
                            "xUnit": "PX",
                            "yUnit": "em",
                        ...
                        "config": {
                            ...
                            "target": {
                                "useEventTarget": "CHILDREN",
                                "id": "60b9005fe0e33682fa48232b|4f219f59-fffb-52de-d322-337c6655039b"
                            },
                            "yValue": 0,
                            "xUnit": "PX",
                            "yUnit": "em",
            ...
            "createdOn": 1623068287469
        },
        "a-8": {
            "id": "a-8",
            "title": "Project slide hover on",
            "actionItemGroups": [{
                "actionItems": [{
                    "id": "a-8-n",
                    "actionTypeId": "STYLE_OPACITY",
                    "config": {
                        ...
                        "target": {
                            "useEventTarget": "CHILDREN",
                            "selector": ".slide-overlay",
                            "selectorGuids": ["f15e92b6-08f0-31f1-d10a-77c8bec2b9ce"]
                        },
                        "value": 0,
                        "unit": ""
                    }
                ...
                "actionItems": [{
                    ...
                    "config": {
                        ...
                        "target": {
                            ...
                            "selectorGuids": ["558c5335-8e8f-a9ca-621f-736f275908ce"]
                        },
                        "xValue": 1.1,
                        "yValue": 1.1,
                        "locked": true
            ...
            "useFirstGroupAsInitialState": true,
            "createdOn": 1623090307563
        },
        "a-9": {
            "id": "a-9",
            "title": "Project slide hover out",
            "actionItemGroups": [{
                "actionItems": [{
                    "id": "a-9-n-2",
                    "actionTypeId": "STYLE_OPACITY",
        ...
        "a-10": {
            "id": "a-10",
            "title": "Gallery pictures moving up",
            "actionItemGroups": [{
                "actionItems": [{
                    "id": "a-10-n",
                    "actionTypeId": "TRANSFORM_MOVE",
                    "config": {
                        ...
                        "duration": 80000,
                        "target": {
                            "selector": ".container.grid.home-v2",
                            "selectorGuids": ["641189cc-f4f3-f4b3-b624-4f9018e183b3", "7d808196-46aa-2277-fd86-8dd05a6529f3", "b9db801a-430b-9cc8-e51a-9726ca58ba53"]
                        },
                        "yValue": -100,
                        "xUnit": "PX",
                        "yUnit": "%",
            ...
            "useFirstGroupAsInitialState": false,
            "createdOn": 1623413900470
        },
        "a-12": {
            "id": "a-12",
            "title": "Next project scroll animation",
            "continuousParameterGroups": [{
                "id": "a-12-p",
                "type": "SCROLL_PROGRESS",
                "parameterLabel": "Scroll",
                    ...
                    "actionItems": [{
                        ...
                        "config": {
                            ...
                            "target": {
                                "useEventTarget": "CHILDREN",
                                "boundaryMode": true,
                                "id": "60ba5a1884b19c5953b78ff6|af866e29-d755-a610-e651-7c7a5470b327"
                            },
                            "yValue": 40,
                            "xUnit": "PX",
                            "yUnit": "%",
